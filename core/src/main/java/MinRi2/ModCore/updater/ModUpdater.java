package MinRi2.ModCore.updater;
...
public class ModUpdater{
    ...
    private ModUpdater(String modName){
        this(modName, VersionChecker.defaultChecker);
    }

    private ModUpdater(String modName, VersionChecker checker){
        this.mod = ModsHelper.getMod(modName);
